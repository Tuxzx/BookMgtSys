...
<div class="container">
    ...
    <div class="row clearfix">
        ...
        <div class="col-md-4 col-lg-4">
            <table class="table">
                <tbody>
                <tr><td>欢迎你：${username}</td></tr>
                <tr><td>在借书数量：${inBorrow}</td></tr>
                <tr><td>总借书数量：${borrowCount}</td></tr>
                </tbody>
            </table>
    ...
    <div class="row clearfix">
        <div class="container">
            <h2>分类</h2>
            <!-- 分类注入id -->
            <div id="category" class="well well-sm">
                <button type="button" class="btn btn-primary" onclick="getBookByType('all')">所有</button>
            </div>
            <div id="bookinfo" class="container"></div>
